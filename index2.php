...
<!-- OMAR -->
				...
				<div class="form-group">
					<label for="direccion" class="col-sm-3 control-label">Dirección (Calle y Número) <span class="important">*</span></label>
            				<div class="col-sm-9">
                				<input type="text" class="form-control" name="direccion" size="40" maxlength="50" value=""  data-error="Ingrese calle y número o cruce de calles"
						placeholder="Av. Merlassino 816 - 2do. Piso" required onChange="direccionar(this.value);" />
            				</div>
...
-->
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="gooMap">
    							<iframe name="mapita2" src="mapaGoogle2.html" width="600" height="525" frameborder="0"></iframe>
						</div>
					</div>
				</div>
<!--
...
function direccionar(dire) {

frames['mapita2'].document.getElementById('geo_directions').value = dire + ", Arrecifes, Buenos Aires";
$(frames['mapita2'].document.getElementById('geo-form-button')).click();
}
...
//OMAR
    $("#direccion").change(function() {
        var from = jQuery.trim($("#direccion").val());
        from = from + "Arrecifes";
        geocoder.geocode({
            address: from,
            language: "es",
        ...
        infowindow.close();
                    ...
                    $("#geo_directions").attr("value", "");
                   infowindow.close();
                   alert("kdk " + results[0].geometry.location);
     }
            }
        });
        return false;
