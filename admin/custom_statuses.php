...
foreach ($hesk_settings['statuses'] as $tmp_id => $status)
{
    ...
    {
        ?>
        <a href="custom_statuses.php?a=edit_status&amp;id=<?php echo $tmp_id; ?>"><img src="../img/edit.png" width="16" height="16" alt="<?php echo $hesklang['edit']; ?>" title="<?php echo $hesklang['edit']; ?>" <?php echo $style; ?> /></a>
        ...
        {
            ?>
            <a href="custom_statuses.php?a=remove_status&amp;id=<?php echo $tmp_id; ?>&amp;token=<?php hesk_token_echo(); ?>" onclick="return hesk_confirmExecute('<?php echo hesk_makeJsString($hesklang['del_status']); ?>');"><img src="../img/delete.png" width="16" height="16" alt="<?php echo $hesklang['delete']; ?>" title="<?php echo $hesklang['delete']; ?>" <?php echo $style; ?> /></a>&nbsp;</td>
            <?php
        }
    }
    else
