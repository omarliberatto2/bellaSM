...
/* OMAR */
echo '        <div class="form-group">
            <label for="direccion" class="col-sm-3 control-label"><span
            class="important">*</span>Dirección (Calle y Número)</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="direccion" size="40" maxlength="50"
                       value="" 
                       data-error="Ingrese calle y número o cruce de calles"
                       placeholder="Av. Merlassino 816 - 2do. Piso" required />
                <div class="help-block with-errors"></div>
            </div>';
