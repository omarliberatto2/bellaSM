...
<div class="box">
	...
	<div class="box-body">
		...
		<form id="reply-form" role="form" data-toggle="validator" class="form-horizontal" method="post" action="admin_reply_ticket.php"
			...
			<!-- impacta en stock OMAR -->
				<div class="form-group">
					<div class="col-sm-3">&nbsp;</div>
					<div class="col-sm-9">
						<a class="btn btn-info btn-block idayvuelta" id="impactarStock" href="../stock/stock.php" target="_blank">Impactar STOCK</a>
					</div>
				</div>
				<script type="text/javascript">
					$(document).on('click', '#impactarStock', function() {
					      $(".idayvuelta").attr("disabled", "disabled");
						});
				</script>
			<?php
			/* attachments */
...
-->
		...
		<script>
			var var_map;
			sessionStorage.latitud = <?php echo $ticket['latitude']; ?>;
			sessionStorage.longitud = <?php echo $ticket['longitude']; ?>;
		</script>
	<div class="gooMap">
			<iframe name="mapita2" src="../mapaGoogle2.html" width="100%" height="525" frameborder="0"></iframe>
	</div>
<!--
// VERSION ACTUAL CON GOOGLEMAPS E IFRAME POR OMAR ************************************************************************************************************
-->
