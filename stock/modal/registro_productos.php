	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div class="form-group">
				<label for="stock" class="col-sm-3 control-label">Stk.Mín.</label>
				<div class="col-sm-8">
				  <input type="number" min="0" class="form-control" id="pr" name="pr" placeholder="Punto de reposición" required  maxlength="8">
				</div>
			</div>
